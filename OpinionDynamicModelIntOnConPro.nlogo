...
to plot-att-distribution
   set-current-plot "Attitude Distribution Map"
   plot-pen-reset                                                    
   set-plot-x-range 1 100                        
...
to update-plot
   ...
   set-current-plot "Attitude Dynamic Map"
...
"Don't Adopters" 1.0 0 -10899396 true
